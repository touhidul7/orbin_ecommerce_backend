    ...
    public function updateProduct(Request $request, $id)
{
    ...
    // Handle image gallery upload - FIXED VERSION
    if ($request->hasFile('image_gallary')) {
        $files = $request->file('image_gallary');
        $filenames = [];
    ...
    // REMOVED THE ELSE CONDITION - Now if no gallery images are uploaded, 
    // the existing image_gallary value will be preserved
